...
public class Client {
	...
	public static void main(String[] args)
		...
		/*
		 * String sql =
		 * "create table books(title varchar(20),authorName varchar(20),category varchar(20),bookId integer, price integer)"
		 * ;
		 * 
		 * Connection connection = ModelDAO.openConnection(); PreparedStatement st; try
